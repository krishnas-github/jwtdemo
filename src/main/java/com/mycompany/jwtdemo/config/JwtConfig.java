...
import com.mycompany.jwtdemo.filtr.JwtAuthenticationFilter;
...
public class JwtConfig extends WebSecurityConfigurerAdapter {
    ...
    //here we can say how we want to manage our authentication process
    @Override
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .anyRequest().authenticated()//for all other request,authentication should performed
                .and()
